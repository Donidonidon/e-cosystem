...
<head>
    ...
    <title>
        BPR Putera Dana - One Team One Energy
    </title>
...
<body>
    ...
    <div class="ud-header bg-dark absolute left-0 top-0 z-40 flex w-full items-center bg-transparent">
        <div class="container">
                        ...
                        @if (Route::has('login'))
                            <div class="hidden sm:flex">
                                ...
                                @else
                                    ...
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}"
                                            class="signUpBtn rounded-md bg-white bg-opacity-20 px-6 py-2 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark">Register</a>
                                    @endif
                                @endauth
                            </div>
                        @endif
        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="img-hero"
                        style="background-image: url('{{ asset('assets/images/hero/bg-hero.jpg') }}');">
                        <div class="container justify-content-center pt-[120px]">
                            <div class="-mx-4 flex flex-wrap items-center">
                                <div class="w-full px-4">
                                    <div class="hero-content wow fadeInUp mx-auto max-w-full text-center "
                                        data-wow-delay=".2s">
                                        <img class="w-1/2 mx-auto"
                                            src="{{ asset('assets/images/hero/goes-to-200.png') }}" alt="">
                                        ...
                                        <div>
                                            <div class="wow fadeInUp flex items-center justify-center gap-4 text-center mt-14"
                                                ...
                                                <a href="https://github.com/TailGrids/play-tailwind/"
                                                    class="text-white/60 duration-300 ease-in-out hover:text-white"
                                                    target="_blank">
                                                    <svg class="fill-current" width="41" height="26"
                                                ...
                                                <a href="https://github.com/NextJSTemplates/play-nextjs"
                                                    class="text-white/60 duration-300 ease-in-out hover:text-white"
                                                    target="_blank">
                                                    <svg class="fill-current" width="41" height="36"
                                                ...
                                                <a href="https://github.com/NextJSTemplates/play-nextjs"
                                                    class="text-white/60 duration-300 ease-in-out hover:text-white"
                                                    target="_blank">
                                                    <svg class="fill-current" width="41" height="40"
                ...
                {{-- <div class="swiper-slide">
                    <div class="img-hero"
                        style="background-image: url('{{ asset('assets/images/hero/bg-hero-1.jpg') }}');"></div>
                </div> --}}
            </div>
            <!-- Pagination -->
                ...
                <div class="w-full px-4">
                    <div class="mx-auto mb-12 max-w-[700px] text-center lg:mb-[70px]">
                        ...
                        <p class="text-base text-body-color dark:text-dark-6">
                            Kami menawarkan berbagai produk keuangan, termasuk tabungan, kredit, dan deposito, untuk
                            memenuhi kebutuhan finansial Anda dengan layanan terbaik.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="w-full px-4 lg:w-1/2">
                        <div class="mb-12 max-w-[540px] lg:mb-0">
                            ...
                            <p class="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6">
                                ...
                                <br>
                                <br>
                                Didalam perkembangan saat ini BPR Putera Dana mengalami pertumbuhan yang positif dengan
                                memiliki asset sebesar 52 Miliyar Per- Desember 2022 dan sedang terus bertumbuh. Didalam
                                pengembangan jaringan kantor, BPR Putera Dana memiliki 4 jaringan kantor.
                            </p>
                        ...
                        <div class="-mx-2 flex flex-wrap sm:-mx-4 lg:-mx-2 xl:-mx-4">
                            <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                                <div class="mb-4 sm:mb-8 sm:h-[400px] md:h-[540px] lg:h-[400px] xl:h-[500px]">
                                    <img src="{{ asset('assets/images/penghargaan/1.jpg') }}" alt="about image"
                            ...
                            <div class="w-full px-2 sm:w-1/2 sm:px-4 lg:px-2 xl:px-4">
                                <div
                                    ...
                                    <img src="{{ asset('assets/images/penghargaan/2.jpg') }}" alt="about image"
                                        class="h-full w-full object-cover object-center" />
                                </div>
            ...
            <div class="-mx-4 flex flex-wrap justify-center">
                <div class="w-full px-4">
                    <div class="mx-auto mb-[60px] max-w-[700px] text-center">
                        <span class="mb-2 block text-lg font-semibold text-primary">
                            Solusi Keuangan yang Terpercaya
                        </span>
                        <h2
                        ...
                        <p class="text-base text-body-color dark:text-dark-6">
                            Kami menyediakan berbagai jenis produk simpanan yang dirancang untuk memenuhi kebutuhan
                            Anda. Nikmati keuntungan, keamanan, dan kemudahan dalam mengelola keuangan Anda bersama
                            kami.
                        </p>
                    </div>
                </div>
            ...
            <div class="-m-5">
                <div class="swiper testimonial-carousel common-carousel p-5">
                    <div class="wow fadeInUp swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="rounded-xl bg-white shadow-testimonial dark:bg-dark">
                                <img src="{{ asset('assets/images/poster/SIMPEL-POSTER.JPG') }}" alt="">
                            </div>
                        </div>

                        <div class="swiper-slide">
                            <div class="rounded-xl bg-white shadow-testimonial dark:bg-dark">
                                <img src="{{ asset('assets/images/poster/TABUNGAN-MASA-DEPAN-POSTER.JPG') }}"
                                    alt="">
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="rounded-xl bg-white shadow-testimonial dark:bg-dark">
                                <img src="{{ asset('assets/images/poster/TABUNGAN-LEBARAN-POSTER.JPG') }}"
                                    alt="">
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="rounded-xl bg-white shadow-testimonial dark:bg-dark">
                                <img src="{{ asset('assets/images/poster/OMPLONGPOSTER.JPG') }}" alt="">
                            </div>
                        </div>

                        <div class="swiper-slide">
                            <div class="rounded-xl bg-white shadow-testimonial dark:bg-dark">
                                <img src="{{ asset('assets/images/poster/TABUNGAN-KAMU-POSTER.JPG') }}"
                                    alt="">
                            </div>
                        </div>
            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4">
                    <div class="mx-auto mb-[60px] max-w-[700px] text-center">
                        ...
                        <p class="text-base text-body-color dark:text-dark-6 ">
                            Temui para pemimpin berdedikasi yang membimbing visi dan misi kami. Direksi PT. BPR Putera
                            Dana memastikan keunggulan, integritas, dan inovasi dalam setiap langkah operasional kami.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            new Swiper('.swiper-container', {
                ...
                effect: 'fade', // Optional: for a fade effect
            });
        });
    </script>
